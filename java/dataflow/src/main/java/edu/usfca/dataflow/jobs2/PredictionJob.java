...
public class PredictionJob {
  ...
  public static void execute(MyOptions options) {
    ...
    PCollection<String> predictionJson = predictions // PC<PredictionData>
        .apply(MapElements.into(TypeDescriptors.strings()).via((PredictionData data) -> {
          try {
