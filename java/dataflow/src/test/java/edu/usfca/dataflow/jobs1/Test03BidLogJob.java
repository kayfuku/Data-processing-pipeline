...
import edu.usfca.dataflow.TestBase;
...
public class Test03BidLogJob {
  ...
  static List<BidLog> getInvalidBidLogs() {
    BidLog.Builder bl = BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
        ...
        .setBidRequest(BidRequest.newBuilder().setId("bidid")
            .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1)
                .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
            .setApp(App.newBuilder().setBundle(TestBase.Bundle1)).build());
  ...
  static List<BidLog> getBidLogs_SetA() {
    ...
    bls.add(BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
        ...
        .setBidRequest(BidRequest.newBuilder().setId("bidid1")
            .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1)
                .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
            .setApp(App.newBuilder().setBundle(TestBase.Bundle1)))
        .build());
    ...
    bls.add(BidLog.newBuilder().setExchange(Exchange.ADX).setBidResult(BidResult.BID).setBidPrice(234)
        ...
        .setBidRequest(BidRequest.newBuilder().setId("bidid2")
            .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1)
                .setGeo(Geo.newBuilder().setCountry("USA").setRegion("ca")))
            .setApp(App.newBuilder().setBundle(TestBase.Bundle3)))
        .build());
    ...
    bls.add(BidLog.newBuilder().setExchange(Exchange.INMOBI).setBidResult(BidResult.BID).setReceivedAt(1234L)
        ...
        .setBidRequest(BidRequest.newBuilder().setId("bidid3")
            .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1)
                .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
            .setApp(App.newBuilder().setBundle(TestBase.Bundle2)))
        .build());
    ...
    bls.add(BidLog.newBuilder().setExchange(Exchange.INMOBI).setBidResult(BidResult.NO_CANDIDATE).setReceivedAt(123456L)
        ...
        .setBidRequest(BidRequest.newBuilder().setId("bidid3")
            .setDevice(Device.newBuilder().setOs("Androi").setIfa(TestBase.UUID1)
                .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
            .setApp(App.newBuilder().setBundle(TestBase.Bundle2)))
        .build());
  ...
  public void testProfileFromBidLog01() {
    ...
    PAssert.that(
        bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
  ...
  public void testProfileFromBidLog02() {
    ...
    PAssert.that(bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          assertTrue(TestBase.UUID1.equalsIgnoreCase(actual.getDeviceId().getUuid()));
  ...
  public void testProfileFromBidLog03() {
    ...
    builder.getBidRequestBuilder().getDeviceBuilder().setIfa(TestBase.UUID1.toUpperCase());
    ...
    PAssert.that(tp.apply(Create.of(bl1, bl2, bl3))
        ...
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          assertTrue(TestBase.UUID1.equalsIgnoreCase(dp1.getDeviceId().getUuid()));
          assertTrue(TestBase.UUID1.equalsIgnoreCase(dp2.getDeviceId().getUuid()));
  ...
  public void testProfileFromBidLog04() {
    ...
    PAssert.that(bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          assertEquals(OsType.ANDROID, actual.getDeviceId().getOs());
          assertEquals(TestBase.UUID1.toLowerCase(), actual.getDeviceId().getUuid().toLowerCase());
          ...
          assertTrue((TestBase.Bundle1.equals(app1.getBundle()) && TestBase.Bundle3.equals(app2.getBundle()))
              || (TestBase.Bundle1.equals(app2.getBundle()) || TestBase.Bundle3.equals(app1.getBundle())));
          if (TestBase.Bundle1.equals(app2.getBundle()) || TestBase.Bundle3.equals(app1.getBundle())) {
            app1 = actual.getApp(1);
            app2 = actual.getApp(0);
          }
          // bundle 1 = app1
          assertEquals(TestBase.Bundle1, app1.getBundle());
          ...
          // bundle 3 = app2
          assertEquals(TestBase.Bundle3, app2.getBundle());
  ...
  public void testProfileFromBidLog05() {
    ...
    bidLogs.addAll(Arrays.asList(
        BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
            .setReceivedAt(12345L).setProcessedAt(123456L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid1")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1.toUpperCase())
                    .setGeo(Geo.newBuilder().setCountry("Usa").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle1.toUpperCase())))
            .build(),
        ...
        BidLog.newBuilder().setExchange(Exchange.ADX).setBidResult(BidResult.BID).setBidPrice(234).setReceivedAt(1234L)
            ...
            .setBidRequest(BidRequest.newBuilder().setId("bidid2")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID1.toUpperCase())
                    .setGeo(Geo.newBuilder().setCountry("USA").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle3.toUpperCase())))
            .build(),
    ...
    PAssert.that(bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          assertTrue(apps.keySet().containsAll(Arrays.asList(TestBase.Bundle1, TestBase.Bundle3,
              TestBase.Bundle3.toUpperCase(), TestBase.Bundle1.toUpperCase())));
          // bundle1
          AppActivity app = apps.get(TestBase.Bundle1);
          assertEquals(TestBase.Bundle1, app.getBundle());
          ...
          app = apps.get(TestBase.Bundle1.toUpperCase());
          assertEquals(TestBase.Bundle1.toUpperCase(), app.getBundle());
          assertEquals(123L, app.getFirstAt());
          assertEquals(12345L, app.getLastAt());
          assertEquals(1, app.getCountPerExchangeOrThrow(Exchange.OPENX_VALUE));
          assertEquals(1, app.getCountPerExchangeOrThrow(Exchange.INMOBI_VALUE));
          ...
          // bundle 3
          app = apps.get(TestBase.Bundle3);
          assertEquals(TestBase.Bundle3, app.getBundle());
          ...
          // bundle 3 - upper
          app = apps.get(TestBase.Bundle3.toUpperCase());
          assertEquals(TestBase.Bundle3.toUpperCase(), app.getBundle());
          assertEquals(1234L, app.getFirstAt());
          assertEquals(1234L, app.getLastAt());
          assertEquals(1, app.getCountPerExchangeOrThrow(Exchange.ADX_VALUE));
  ...
  public void testProfileFromBidLog06() {
    ...
    bidLogs.addAll(Arrays.asList(
        BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
            .setReceivedAt(12345L).setProcessedAt(123456L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid1")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID2.toLowerCase())
                    .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle1)))
            .build(),
        ...
        BidLog.newBuilder().setExchange(Exchange.ADX).setBidResult(BidResult.BID).setBidPrice(234).setReceivedAt(1234L)
            .setProcessedAt(12345L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid2")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID2.toUpperCase())
                    .setGeo(Geo.newBuilder().setCountry("USA").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle3)))
            .build(),
    ...
    PAssert.that(bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          for (DeviceProfile actual : out) {
            assertTrue(DeviceProfileUtils.isDpValid(actual));
            assertEquals(OsType.ANDROID, actual.getDeviceId().getOs());
            uuid1 |= StringUtils.equalsIgnoreCase(TestBase.UUID1.toLowerCase(),
                actual.getDeviceId().getUuid().toLowerCase());
            uuid2 |= StringUtils.equalsIgnoreCase(TestBase.UUID2.toLowerCase(),
                actual.getDeviceId().getUuid().toLowerCase());
  ...
  public void testProfileFromBidLog07() {
    ...
    bidLogs.addAll(Arrays.asList(
        BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
            .setReceivedAt(12345L).setProcessedAt(123456L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid1")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID3.toLowerCase())
                    .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle2)))
            .build(),
        ...
        BidLog.newBuilder().setExchange(Exchange.ADX).setBidResult(BidResult.BID).setBidPrice(99).setReceivedAt(12L)
            .setProcessedAt(12345L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid2")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID3.toUpperCase())
                    .setGeo(Geo.newBuilder().setCountry("uSa").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle3)))
            .build(),
        ...
        BidLog.newBuilder().setExchange(Exchange.INMOBI).setBidResult(BidResult.BID).setBidPrice(567)
            .setReceivedAt(123L).setProcessedAt(1234567L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid3")
                .setDevice(Device.newBuilder().setOs("And").setIfa(TestBase.UUID3)
                    .setGeo(Geo.newBuilder().setCountry("usa").setRegion("nv")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle1)))
            .build()));
    ...
    PAssert.that(bls.apply(MapElements.into(TypeDescriptor.of(byte[].class)).via((BidLog bl) -> bl.toByteArray()))
        .apply(new BidLog2DeviceProfile())).satisfies(out -> {
          ...
          for (DeviceProfile actual : out) {
            assertTrue(DeviceProfileUtils.isDpValid(actual));
            assertEquals(OsType.ANDROID, actual.getDeviceId().getOs());
            if (StringUtils.equalsIgnoreCase(TestBase.UUID1, actual.getDeviceId().getUuid())) {
              uuid1 = true;
              assertEquals(123L, actual.getFirstAt());
              assertEquals(12345L, actual.getLastAt());
              ...
              assertTrue(geos.contains(KV.of("USA", "ca")));
              assertTrue(geos.contains(KV.of("usa", "nv")));
            } else if (StringUtils.equalsIgnoreCase(TestBase.UUID3, actual.getDeviceId().getUuid())) {
              uuid2 = true;
              ...
              AppActivity app1 = actual.getApp(0);
              AppActivity app2 = actual.getApp(1);
              assertTrue((TestBase.Bundle2.equals(app1.getBundle()) && TestBase.Bundle3.equals(app2.getBundle()))
                  || (TestBase.Bundle2.equals(app2.getBundle()) || TestBase.Bundle3.equals(app1.getBundle())));
              if (TestBase.Bundle2.equals(app2.getBundle()) || TestBase.Bundle3.equals(app1.getBundle())) {
                app1 = actual.getApp(1);
                app2 = actual.getApp(0);
              }
              // bundle 2 = app1
              assertEquals(TestBase.Bundle2, app1.getBundle());
  ...
  public void testProfileFromBidLog08() {
    ...
    bidLogs.addAll(Arrays.asList(
        BidLog.newBuilder().setExchange(Exchange.OPENX).setBidResult(BidResult.BID).setBidPrice(123)
            .setReceivedAt(12345L).setProcessedAt(123456L)
            .setBidRequest(BidRequest.newBuilder().setId("bidid1")
                .setDevice(Device.newBuilder().setOs("Android").setIfa(TestBase.UUID3)
                    .setGeo(Geo.newBuilder().setCountry("usa").setRegion("ca")))
                .setApp(App.newBuilder().setBundle(TestBase.Bundle2)))
            .build(),
