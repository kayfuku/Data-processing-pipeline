...
import static edu.usfca.dataflow.TestBase.UUID1;
import static org.junit.Assert.*;

public class Test04BidLogJob {
  @Rule
  ...
  public void testAppProfile_basic01() {
    ...
    AppActivity.Builder app1 = AppActivity.newBuilder().setBundle(TestBase.Bundle1).setFirstAt(10000L)
        .setLastAt(12000L).putCountPerExchange(Exchange.INMOBI_VALUE, 2).putCountPerExchange(Exchange.USF_VALUE, 3);
    AppActivity.Builder app2 = AppActivity.newBuilder().setBundle(TestBase.Bundle2).setFirstAt(15000L)
    ...
    PAssert.that(tp.apply(Create.of(life1.build())).apply(new ComputeAppProfiles())).satisfies(out -> {
      ...
      assertTrue(profiles.keySet().containsAll(Arrays.asList(TestBase.Bundle1, TestBase.Bundle2)));

      {
        AppProfile _app = profiles.get(TestBase.Bundle1);
      ...
      {
        AppProfile _app = profiles.get(TestBase.Bundle2);
        assertEquals(1, _app.getUserCount());
  ...
  public void testAppProfile_basic02() {
    DeviceId.Builder did1 = DeviceId.newBuilder().setOs(OsType.IOS).setUuid(UUID1);
    DeviceId.Builder did2 = DeviceId.newBuilder().setOs(OsType.IOS).setUuid(TestBase.UUID2);
  ...
  static DeviceProfile getSampleDp(int c) {
    DeviceId.Builder did = DeviceId.newBuilder().setOs(OsType.IOS).setUuid(TestBase.Bundle1);
    ...
    switch (c) {
      ...
      case 11:
        return dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).clearCountPerExchange()).build();
      case 12:
        return dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).putCountPerExchange(10, 1)).build();
      case 13:
        return dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).putCountPerExchange(5, 0)).build();
      case 14:
        return dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).setFirstAt(20001L).setLastAt(20001L))
            .build();
      case 15:
        return dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).setFirstAt(2001L).setLastAt(2001L))
            .build();
      case 16:
  ...
  public void testAppProfile_basic() {
    ...
    AppActivity.Builder app2 = AppActivity.newBuilder().setBundle(TestBase.Bundle2).setFirstAt(15000L)
        .setLastAt(20000L).putCountPerExchange(Exchange.USF_VALUE, 2).putCountPerExchange(Exchange.CS_VALUE, 3);
    AppActivity.Builder app5 = AppActivity.newBuilder().setBundle(TestBase.Bundle1).setFirstAt(8000L)
  ...
  public void testAppProfile_all2() {
    DeviceId.Builder did1 = DeviceId.newBuilder().setOs(OsType.IOS).setUuid(UUID1);
    DeviceId.Builder did2 = DeviceId.newBuilder().setOs(OsType.IOS).setUuid(TestBase.UUID2);
    DeviceId.Builder did3 = DeviceId.newBuilder().setOs(OsType.ANDROID).setUuid(TestBase.UUID3);
    DeviceId.Builder did4 = DeviceId.newBuilder().setOs(OsType.ANDROID).setUuid(TestBase.UUID4);
    ...
    AppActivity.Builder app2 = AppActivity.newBuilder().setBundle(TestBase.Bundle2).setFirstAt(15000L)
        .setLastAt(20000L).putCountPerExchange(Exchange.USF_VALUE, 2).putCountPerExchange(Exchange.CS_VALUE, 3);
    AppActivity.Builder app3 = AppActivity.newBuilder().setBundle(TestBase.Bundle3).setFirstAt(5000L)
        .setLastAt(10000L).putCountPerExchange(Exchange.USF_VALUE, 2).putCountPerExchange(Exchange.ADX_VALUE, 3);
    AppActivity.Builder app4 = AppActivity.newBuilder().setBundle(TestBase.Bundle4).setFirstAt(8000L).setLastAt(9000L)
    ...
    PAssert.that(
        ...
        .satisfies(out -> {
          ...
          assertTrue(profiles.keySet().containsAll(
              Arrays.asList(TestBase.Bundle1, TestBase.Bundle2, TestBase.Bundle3, TestBase.Bundle4)));
          ...
          {
            AppProfile _app = profiles.get(TestBase.Bundle3);
          ...
          {
            AppProfile _app = profiles.get(TestBase.Bundle4);
            assertEquals(2, _app.getUserCount());
            assertEquals(0, _app.getUserCountPerExchangeOrDefault(Exchange.CS_VALUE, 0));
            assertEquals(0, _app.getUserCountPerExchangeOrDefault(Exchange.ADX_VALUE, 0));
