...
import static edu.usfca.dataflow.TestHelper.areDeviceProfileSetsEqual;
import static edu.usfca.dataflow.TestHelper.getDpWithCanonicalId;
...
public class Test07BidLogJob {
  ...
  public void testAppProfiles() {
    ...
    PCollection<AppProfile> appProfiles = rawData
        .apply(new BidLog2DeviceProfile())
