 ...
 */
public class Test02DeviceProfileUtils {
  ...
  public void testIsDeviceIdValid() {
    assertTrue(DeviceProfileUtils
        .isDeviceIdValid(DeviceId.newBuilder().setOs(OsType.IOS).setUuid(TestBase.Bundle1).build()));
    assertTrue(DeviceProfileUtils
        .isDeviceIdValid(DeviceId.newBuilder().setOs(OsType.IOS).setUuid(TestBase.Bundle1.toUpperCase()).build()));
    assertTrue(DeviceProfileUtils.isDeviceIdValid(
        DeviceId.newBuilder().setOs(OsType.ANDROID).setUuid(TestBase.Bundle1.toUpperCase()).build()));

    assertFalse(DeviceProfileUtils.isDeviceIdValid(
        DeviceId.newBuilder().setOs(OsType.UNKNOWN_OS_TYPE).setUuid(TestBase.Bundle1.toUpperCase()).build()));
    assertFalse(DeviceProfileUtils
        .isDeviceIdValid(DeviceId.newBuilder().setOs(OsType.UNKNOWN_OS_TYPE).setUuid(TestBase.Bundle1).build()));
    assertFalse(DeviceProfileUtils.isDeviceIdValid(DeviceId.newBuilder().setUuid(TestBase.Bundle1).build()));
  ...
  public void testIsDeviceIdValid2() {
    ...
    dp = _dp.build().toBuilder();
    assertFalse(DeviceProfileUtils
        .isDpValid(dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).clearCountPerExchange()).build()));
    dp = _dp.build().toBuilder();
    assertFalse(DeviceProfileUtils.isDpValid(
        dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).putCountPerExchange(15, 1)).build()));
    dp = _dp.build().toBuilder();
    assertFalse(DeviceProfileUtils.isDpValid(
        dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).putCountPerExchange(5, 0)).build()));
    dp = _dp.build().toBuilder();
    assertFalse(DeviceProfileUtils.isDpValid(dp
        .addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).setFirstAt(20001L).setLastAt(20001L)).build()));
    dp = _dp.build().toBuilder();
    assertFalse(DeviceProfileUtils.isDpValid(
        dp.addApp(app2.build().toBuilder().setBundle(TestBase.Bundle3).setFirstAt(2001L).setLastAt(2001L)).build()));
